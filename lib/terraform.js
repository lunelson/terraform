...
var fixture    = require('fixture-factory')
  ...
  return {
    ...
    render: function(filePath, locals, callback){
      ...
      if(helpers.isTemplate(filePath)) {
        ...
        locals.faker   = faker
        locals.fixture = fixture
        locals.moment  = moment
        locals.current = helpers.getCurrent(filePath)
        locals.getFile = require('./template/helpers/getFile')
        locals.parseMD = require('./template/helpers/parseMD')
