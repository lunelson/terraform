  ...
  return {
    ...
    render: function(filePath, locals, callback){
      ...
      if(helpers.isTemplate(filePath)) {
         ...
         */
        locals._        = lodash
        locals.chance   = new Chance()
        locals.faker    = faker
        locals.ff       = fixtureFactory
        locals.moment   = moment
        locals.current  = helpers.getCurrent(filePath)
        locals.rawFile  = require('./template/helpers/rawfile')
        locals.mdFile   = require('./template/helpers/mdfile')
        locals.mdFolder = require('./template/helpers/mdfolder')
