...
helpers.processors["js"].forEach(function(sourceType){ extensions.push('.' + sourceType) })
...
module.exports = function(root, filePath, callback){
  ...
  fs.readFile(srcPath, function(err, data){
    ...
    browserify(srcPath, {extensions: extensions, debug: true})
      .transform('coffeeify') // re-supply the extensions here?
      .transform('babelify')
      .bundle()
